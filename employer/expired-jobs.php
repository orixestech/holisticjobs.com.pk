<?php include('header.php');?>
    <?php
if($_GET["status"]=='true' && $_GET["id"] && $_GET["status"]){
...
$QUERYSTRING = '';
$whereSQL = "where JobEmployerID = '".$_SESSION['EmployerUID']."' and JobLastDateApply <= '".date("Y-m-d")."' ";
    ...
    <div class="main-content">
      <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
          ...
          <li class="active">Expired Jobs</li>
        </ul>
      ...
      <div class="page-content"> 
        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="col-xs-12">
              <h3 class="header smaller lighter blue">Expired Jobs</h3>
              <div id="ajax-result">
                <?=$message?>
              </div>
              <div class="col-xs-12">
                  ...
                  <div class="widget-body">
                    <div class="widget-main">
                      <form class="form-inline" id="admin-meeting-filter-form" method="get">
                        ...
                        <div class="col-xs-1 col-sm-1"> <a href="expired-jobs.php" style="margin-top:24px;" class="btn btn-success btn-sm"> Clear </a> </div>
                      </form>
              ...
              $paging = getPaging('jobs',$whereSQL . " ORDER BY `SystemDate` DESC ",$limit,'expired-jobs.php','?'.$QUERYSTRING,$_REQUEST['pager']);
              //echo $paging[0];
                      ...
                      <tr>
                        ...
                        <td><?php
						  $data = array(
									  ...
									  array('title'=>'<i class="icon-trash bigger-130"></i>', 'href'=>'javascript:void(0)', 'js'=>' onclick="ConfirmDelete(\'expired-jobs.php?delete=true&id='.$rslt['UID'].'\')" class="red ConfirmDelete"  title="Delete" ')
