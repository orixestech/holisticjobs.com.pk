...
$FormPages = array('job.php','page.php','profile.php','post-job.php','published-jobs.php','unpublished-jobs.php','expired-jobs.php');
			...
			jQuery(function($) {
				$("#'.$divid.'").on("show.bs.modal", function (event) {
					...
					if( $("#'.$divid.'").load() ){
						...
						$("#'.$divid.' .modal-content").load("'.$path.'employer/inner-html/'.$filename.'?uid="+uid+"&r="+Math.random(), function ()
						{ 
							return true;
						});
					}
