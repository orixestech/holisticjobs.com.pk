	...
	<div class="padding-right">
		...
		<ul class="job-list full">
			...
			<li><a href="job-page.html">
				<img src="<?=$path?>images/job-list-logo-01.png" alt="">
			...
			<li><a href="job-page.html">
				<img src="<?=$path?>images/job-list-logo-02.png" alt="">
				<div class="job-list-content">
			...
			<li><a href="job-page-alt.html">
				<img src="<?=$path?>images/job-list-logo-03.png" alt="">
				<div class="job-list-content">
			...
			<li><a href="job-page.html">
				<img src="<?=$path?>images/job-list-logo-04.png" alt="">
				<div class="job-list-content">
			...
			<li><a href="job-page-alt.html">
				<img src="<?=$path?>images/job-list-logo-05.png" alt="">
				<div class="job-list-content">
