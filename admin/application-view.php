  ...
  <div class="page-content">
    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="row">
          <div class="col-xs-12">
            <h3 class="header smaller lighter blue">Applications</h3>
            <div id="ajax-result">
              <?=$message?>
            </div>
            <div class="col-xs-12">
            ...
            <div class="col-xs-12">
              ...
              <div class="table-responsive">
				...
				$paging = getPaging('jobs',$whereSQL . " ORDER BY `SystemDate` DESC ",$limit,'jobs-view.php','?'.$QUERYSTRING,$_REQUEST['pager']);
				//echo $paging[0];
			  ...
			  if($row>0){
				...
				$totalApplicatoin = total("SELECT * FROM `jobs_apply` WHERE `JobID` = '".$rslt['UID']."' "); ?>
                    <tr id="row_<?=$rslt['UID']?>">
                      <td><?=$count?></td>
                      <td><?=GetCategory($rslt['JobCategory'])?></td>
                    ...
                    <div style="margin-top:5px;"></div>
                    <script type="IN/Share" data-url="<?=JobLink($rslt['UID'])?>" data-counter="right"></script>
                      </td>
                    </tr>
                    <? $count++;
				  }
