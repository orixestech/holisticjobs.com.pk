...
//			/////////////// Upload Orixes Host
//			$file = "mysql_backup/" . $backup;
//			$remote_file = "/public_html/projects/holisticjobs.com.pk/" . $backup;
//			$remote_file = $backup;
//			/* FTP Account */
//			$ftp_host = 'orixestech.com'; /* host */
//			$ftp_user_name = 'php@orixestech.com'; /* username */
//			$ftp_user_pass = 'QBb(0.5BPT.6'; /* password */
            ...
            <div class="table-responsive">
              <table class="table table-striped table-bordered table-hover">
				...
				foreach($FileList as $val){ ?>
                  <tr>
                    <td><?=date("F d Y h:i A", filemtime("mysql_backup/".$val) );?></td>
                    <td><a href="download_database.php?file=<?=$val?>">
                      <?=$val?>
                      </a></td>
                    <td><?=@round(filesize("mysql_backup/".$val)/1024,2)?>
                      Kb</td>
                  </tr>
                  <?php } ?>
                </tbody>
