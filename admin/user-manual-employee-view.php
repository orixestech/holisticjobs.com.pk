    ...
    <div class="main-content">
      <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
          ...
          <li class="active">Employee User Manual</li>
        </ul>
        <!-- .breadcrumb -->
      </div>
      <div class="page-content">
        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <div class="row">
              <div class="col-xs-12">
                <h3 class="header smaller lighter blue">Employee User Manual</h3>
                <div id="ajax-result">
                  <?=$message?>
                </div>
                <div class="col-xs-12">
                  <div class="table-header"> Results for "All User Manuals for Employee"</div>
				...
				$whereSQL = "WHERE `category`.`type` = 'User-Manual-Employee' ";
				...
				$pagination = $paging[1];?>
                  ...
                  $categoryPrint = $rslt['title'];?>
                        <tr>
                          ...
                          <td><?php
                       $data = array(
                        array('title'=>'<i class="icon-pencil bigger-130"></i>', 'href'=>'user-manual-employee.php?mode=update&code='.$rslt['UID'], 'js'=>' role="button" class="green" title="Edit Question"'),
