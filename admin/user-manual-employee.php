  ...
  <div class="breadcrumbs" id="breadcrumbs">
    <ul class="breadcrumb">
      ...
      <li class="active">
        ...
        Employee User Manual </li>
    </ul>
    <!-- .breadcrumb -->
  </div>
  <div class="page-content">
    <div class="page-header">
      <h1><?=($_GET["code"])?'Modify':'Add New'?> User Manual<small> <i class="icon-double-angle-right"></i> <?=($_GET["code"])?'Modify':'Add New'?> Employee User Manual </small> </h1>
    </div>
    <!-- /.page-header -->
    <?=$FormMessge?>
          ...
          <div class="row">
            <div class="form-group">
              ...
              <div class="col-sm-9">
                ...
                <?php echo CategoryDropDown('User-Manual-Employee',$PAGE['ManualCategory']);?>
                </select>
              </div>
            </div>
            <div class="form-group">
