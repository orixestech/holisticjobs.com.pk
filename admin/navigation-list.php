        ...
        <div class="col-xs-12">
          ...
          <h4 class="header green">Basic Details</h4>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" id="EmployeeDOB" name="EmployeeDOB" placeholder="EmployeeDOB" data-date-format="yyyy-mm-dd" class="col-xs-5 col-sm-5 date-picker validate[custom[date],future[1970-01-01],past[1995-01-01]]" value="<?=date("Y-m-d", strtotime($PAGE['EmployeeDOB']))?>" />
              </div>
            </div>
            <div class="form-group">
