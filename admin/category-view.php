...
$_GET['type'] = $_GET['type'] ? $_GET['type'] : 'Jobs';
...
<div class="main-content">
  <div class="breadcrumbs" id="breadcrumbs">
    <ul class="breadcrumb">
      ...
      <li class="active">
        <?php
	  if($_GET['type'] == 'Jobs') echo "Jobs Categories"; ?>
      </li>
    </ul>
    <!-- .breadcrumb -->
  </div>
              ...
              <div class="row">
                <div class="col-xs-12">
                  ...
                  <div class="row">
                    ...
                    <div class="space-4"></div>
                    <div class="form-group">
                      <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Category Image <small>150px * 40px</small></label>
                      <div class="col-sm-8"> <img id="existing_image" src="" style="display:none; width:150px; height:40px; margin-bottom:10px;" />
