...
<form id="ManageAccessForm">
  <input type="hidden" name="Module" id="Module" value="Employee" />
  ...
  <div class="slim-scroll" data-height="500">
    <div class="table-responsive">
      <table class="table table-striped table-bordered table-hover" id="ManageAccess">
        ...
        <tbody>
          <?php
        $stmt = query(" SELECT * FROM subscription_accesstype WHERE AccessTypeModule = 'Employee' ORDER BY AccessTypeTitle ");
