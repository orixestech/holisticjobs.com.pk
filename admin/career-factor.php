...
$_GET['type'] = $_GET['type'] ? $_GET['type'] : 'Career-Factor';
...
<div class="main-content">
  <div class="breadcrumbs" id="breadcrumbs">
    <ul class="breadcrumb">
      ...
      <li class="active">
        <?php
	  if($_GET['type'] == 'Career-Factor') echo "Career Factors"; ?>
      </li>
    </ul>
    <!-- .breadcrumb -->
  </div>
        ...
        <div class="row">
          <div class="col-xs-8">
            <h3 class="header smaller lighter blue">
              <?php
			  if($_GET['type'] == 'Career-Factor') echo "Career Factor"; ?>
            </h3>
            <?=$message?>
            <div class="table-header"> Results for "All Factors"
              <?php
			  if($_GET['type'] == 'Career-Factor') echo "Career Factor"; ?>
              " </div>
