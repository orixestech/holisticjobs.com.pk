      ...
      <div class="page-content"> 
        ...
        <div class="row">
          <div class="col-xs-12"> 
            ...
            <div class="row">
              <div class="col-xs-12">
                <h3 class="header smaller lighter blue">Employer Subscription Access Type</h3>
                ...
                <div class="col-xs-12">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover ">
                      <?php
					$QUERYSTRING = '';
					$whereSQL = " where `AccessTypeModule` = 'Employer' ";
					$limit = 15;
					(!$_REQUEST['pager'])?$_REQUEST['pager']=1:'';
					$count = ( $limit * ( $_REQUEST['pager'] - 1 ) ) + 1 ;
					$paging = getPaging('subscription_accesstype',$whereSQL . " ORDER BY AccessTypeTitle ",$limit,'employer-access-type.php','?'.$QUERYSTRING,$_REQUEST['pager']);
					//echo $paging[0];
