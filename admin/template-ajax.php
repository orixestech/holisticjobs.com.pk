...

{
	...
	$firstname = GetData('firstname', 'members', '`id`', $_REQUEST["member_id"]);

	$lastname = GetData('lastname', 'members', '`id`', $_REQUEST["member_id"]);
...

	{
		...
		Track('Member [ '.$firstname.' '.$lastname.' ] Deleted Successfully ...!');

		echo $message = Alert('success', 'Member [ '.$firstname.' '.$lastname.' ] Deleted Successfully ...!');
...
elseif($_REQUEST["action"]=='template_status')

{

	mysql_query(" UPDATE `templates` SET `status` = '".$_REQUEST["status"]."' WHERE `templates`.`id` = '".$_REQUEST["template_id"]."'; ");
	$num = mysql_affected_rows();
	$return = array();
	if($num)
	{
		//Track('Member [ '.$firstname.' '.$lastname.' ] Status Updated Successfully ...!');
		$return['status'] = 'success';
		$return['data'] = Alert('success', 'Template Status Updated Successfully ...!');
	}
	else
	{
