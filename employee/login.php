...
$employee_path = $path . "employee/";
if ($_SERVER['HTTP_HOST'] != 'localhost'){
	if ($_SERVER['HTTP_HOST'] != 'www.holisticjobs.com.pk'){
		echo "<script language='javascript'>window.location = '".$employee_path."';</script>"; exit;
	}
}
/////////////////////////////////////
...
if(isset($_POST['form']) && $_POST['form'] == 'login'){
	if(isset($_POST['Username']) && isset($_POST['Password'])){
		$SQL = " SELECT * FROM `employee` WHERE EmployeeStatus = 'Active' and EmployeeEmail = '".$_POST['Username']."' and EmployeePassword = '".PassWord($_POST['Password'],'hide')."' ";
    ...
    <div class="row">
      <div class="col-sm-10 col-sm-offset-1">
        <div class="login-container">
          <div class="center"> <img src="<?=$path?>images/logo.png" width="100%" alt="Employer Portal"> </div>
          <div class="space-6"></div>
          <div class="position-relative">
            <div id="login-box" class="login-box visible widget-box no-border">
              <div class="widget-body">
                <div class="widget-main">
				<h2 class="header blue lighter bigger"> Employee Portal</h2>
                  ...
                  <form method="post" action="">
                    ...
                    <fieldset>
                      <label class="block clearfix"> <span class="block input-icon input-icon-right">
                        <input type="text" class="form-control" placeholder="Your Login Email..." name="Username" value="" />
                        <i class="icon-user"></i> </span> </label>
                      <label class="block clearfix"> <span class="block input-icon input-icon-right">
                        <input type="password" class="form-control" placeholder="Your Login Password..." name="Password" value="" />
