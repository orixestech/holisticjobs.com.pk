...
if($_GET['delete']=='true'){
	mysql_query( " DELETE FROM `admin_log` WHERE `logref` = 'employee' and `logrefid` = '".$_SESSION['EmployeeUID']."' " );
}
?>
            ...
            <div class="table-responsive">
              <table id="pages-view" class="table table-striped table-bordered table-hover ">
                ...
                <tbody>
                  <?php
				  	$query = '';
                    $stmt = mysql_query(" SELECT * FROM `admin_log` WHERE `logref` = 'employee' and `logrefid` = '".$_SESSION['EmployeeUID']."'  order by `logdatetime` desc ");
